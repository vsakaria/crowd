...
$(document).ready(function() {
  ...
  $(document).on('submit.add-song-submit-btn', '.add-to-playlist-form', function(e) {
    ...
    console.log(song_id);
    console.log("this is being triggered" + current_playlist_id);
...
// $.on('submit.remove-song-submit-btn').click(function () {
//   $('.remove-from-playlist-form').remove();
// });

$(document).on('submit.remove-song-submit-btn', '.remove-from-playlist-form', function(e) {
      e.preventDefault();
       var selected_song = $(this);
    var song_title = $(this).find('label').text();
    var song_artist_name = $(this).find('.artist_name').val();
    ...
    var deleteSongsForPlaylist = function(song_title, song_artist_name, song_artist_id, song_id, current_playlist_id) {
      $.post( '/songs/song_id', 
              { song: { title: song_title, 
                        artist_name: song_artist_name,
                        artist_id: song_artist_id,
